...
const baseProviderSettingsSchema = z.object({
	...
	morphApiKey: z.string().optional(), // oacode_change: Morph fast apply
...
// oacode_change start
const oacodeSchema = baseProviderSettingsSchema.extend({
	oacodeToken: z.string().optional(),
	oacodeModel: z.string().optional(),
	openRouterSpecificProvider: z.string().optional(),
})
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	oacodeSchema.merge(z.object({ apiProvider: z.literal("oacode") })),

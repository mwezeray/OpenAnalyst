/* eslint-disable @typescript-eslint/no-unused-vars */ /* oacode_change this file is meant to be a stub */
import { TelemetryEventName, type TelemetryEvent, type ClineMessage } from "@roo-code/types" // oacode_change removed rooCodeTelemetryEventSchema because unused
import { BaseTelemetryClient } from "@roo-code/telemetry"

// import { getRooCodeApiUrl } from "./config" // oacode_change

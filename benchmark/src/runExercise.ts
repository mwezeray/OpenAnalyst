...
export async function run() {
	...
	const extension = vscode.extensions.getExtension<RooCodeAPI>("oacode.Oa-Code")
	...
	/**
	 * Wait for the OpenAnalyst to be ready to accept tasks.
	 */

	await waitUntilReady({ api })

	/**
	 * Configure OpenAnalyst as needed.
	 *

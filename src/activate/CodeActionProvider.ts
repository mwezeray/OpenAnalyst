...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with OpenAnalyst",
	FIX: "Fix with OpenAnalyst",
	IMPROVE: "Improve with OpenAnalyst",
	ADD_TO_CONTEXT: "Add to OpenAnalyst",
	NEW_TASK: "New OpenAnalyst Task",
} as const

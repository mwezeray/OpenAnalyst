...
export type GetModelsOptions =
	| { provider: "openrouter"; apiKey?: string; baseUrl?: string } // oacode_change: add apiKey, baseUrl
	| { provider: "glama" }
	| { provider: "requesty"; apiKey?: string }
	| { provider: "unbound"; apiKey?: string }
	| { provider: "litellm"; apiKey: string; baseUrl: string }
	| { provider: "oacode-openrouter"; oacodeToken?: string } // oacode_change
	| { provider: "cerebras"; cerebrasApiKey?: string } // oacode_change

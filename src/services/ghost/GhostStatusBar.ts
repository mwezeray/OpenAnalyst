...
export class GhostStatusBar {
	...
	private init() {
		this.statusBar.text = t("oacode:ghost.statusBar.enabled")
		this.statusBar.tooltip = t("oacode:ghost.statusBar.tooltip.basic")
		this.show()
	}
	...
	private humanFormatCost(cost: number): string {
		if (cost === 0) return t("oacode:ghost.statusBar.cost.zero")
		if (cost > 0 && cost < 0.01) return t("oacode:ghost.statusBar.cost.lessThanCent") // Less than one cent
	...
	private renderDisabled() {
		this.statusBar.text = t("oacode:ghost.statusBar.disabled")
		this.statusBar.tooltip = t("oacode:ghost.statusBar.tooltip.disabled")
	}

	private renderTokenError() {
		this.statusBar.text = t("oacode:ghost.statusBar.warning")
		this.statusBar.tooltip = t("oacode:ghost.statusBar.tooltip.tokenError")
	}
	...
	private renderDefault() {
		...
		this.statusBar.text = `${t("oacode:ghost.statusBar.enabled")} (${totalCostFormatted})`
		this.statusBar.tooltip = `\
${t("oacode:ghost.statusBar.tooltip.basic")}
• ${t("oacode:ghost.statusBar.tooltip.lastCompletion")} $${lastCompletionCostFormatted}
• ${t("oacode:ghost.statusBar.tooltip.sessionTotal")} ${totalCostFormatted}
• ${t("oacode:ghost.statusBar.tooltip.model")} ${this.model}\
`
	}

...
vi.mock("fs/promises")
vi.mock("../roo-config", () => ({
	getGlobalRooDirectory: vi.fn(() => "/mock/global/.oacode"),
	getProjectRooDirectoryForCwd: vi.fn(() => "/mock/project/.oacode"),
}))
...
\`\`\``
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".oacode", "commands", "setup.md"),
				description: "Sets up the development environment",
...
Global setup instructions.`
			...
			expect(result).toEqual({
				...
				source: "global",
				filePath: expect.stringContaining(path.join(".oacode", "commands", "setup.md")),
				description: "Global setup command",
				argumentHint: undefined,
			})
		})
...
Create a new release.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".oacode", "commands", "release.md"),
				description: "Create a new release of the Roo Code extension",
...
Deploy the application.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".oacode", "commands", "deploy.md"),
				description: "Deploy application to environment",

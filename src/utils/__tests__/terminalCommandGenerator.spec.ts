...
vi.mock("../../i18n", () => ({
	t: vi.fn((key: string, params?: any) => {
		const translations: Record<string, string> = {
			"oacode:terminalCommandGenerator.inputPrompt": "Oa: Describe the command you want to generate",
			"oacode:terminalCommandGenerator.inputPlaceholder":
				"e.g., kill the process running on port 3001, find large files, etc",
			"oacode:terminalCommandGenerator.noActiveTerminal":
				"No active terminal found. Please open a terminal first.",
			"oacode:terminalCommandGenerator.generatingProgress": "Generating terminal command...",
			"oacode:terminalCommandGenerator.commandGenerated": `Generated command: ${params?.command || ""}`,
			"oacode:terminalCommandGenerator.generationFailed": `Failed to generate command: ${params?.error || ""}`,
			"oacode:terminalCommandGenerator.warningDialog.title": "Always Verify AI-Generated Commands",
			"oacode:terminalCommandGenerator.warningDialog.message":
			...
			"oacode:terminalCommandGenerator.warningDialog.okButton": "OK, I Understand",
			"oacode:terminalCommandGenerator.warningDialog.cancelButton": "Cancel",
		}
...
describe("generateTerminalCommand", () => {
	...
	it("should generate and place terminal command without executing", async () => {
		...
		expect(vscode.window.showInputBox).toHaveBeenCalledWith({
			prompt: "Oa: Describe the command you want to generate",

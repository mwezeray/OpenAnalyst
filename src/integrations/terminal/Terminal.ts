...
import { getWorkspacePath } from "../../utils/path" // oacode_change
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "OpenAnalyst", iconPath, env })
	...
	public static getEnv(): Record<string, string> {
		const env: Record<string, string> = {
			...
			WORKSPACE_ROOT: getWorkspacePath(), // oacode_change
		}

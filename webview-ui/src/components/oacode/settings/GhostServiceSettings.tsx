				...
				<div className="flex flex-col gap-3">
					<div className="flex flex-col gap-1">
						<div className="flex items-center gap-2 font-bold">
							...
							<div>{t("oacode:ghost.settings.autoTrigger")}</div>
						</div>
					</div>

					<div className="flex flex-col gap-1">
						<ControlledCheckbox checked={enableAutoTrigger || false} onChange={onEnableAutoTriggerChange}>
							<span className="font-medium">{t("oacode:ghost.settings.enableAutoTrigger.label")}</span>
						</ControlledCheckbox>
						<div className="text-vscode-descriptionForeground text-sm mt-1">
							<Trans i18nKey="oacode:ghost.settings.enableAutoTrigger.description" />
						</div>
					</div>
					...
					{enableAutoTrigger && (
						<div className="flex flex-col gap-1">
							<label className="block font-medium text-sm">
								{t("oacode:ghost.settings.autoTriggerDelay.label")}
							</label>
							...
							<div className="text-vscode-descriptionForeground text-xs mt-1">
								<Trans i18nKey="oacode:ghost.settings.autoTriggerDelay.description" />
							</div>
						</div>
					)}
				</div>
				...
				<div className="flex flex-col gap-3">
					<div className="flex flex-col gap-1">
						<div className="flex items-center gap-2 font-bold">
							...
							<div>{t("oacode:ghost.settings.triggers")}</div>
						</div>
					</div>

					<div className="text-vscode-descriptionForeground text-sm mb-3">
						<Trans
							i18nKey="oacode:ghost.settings.keybindingDescription"
							components={{
								DocsLink: (
									<a
										href="#"
					...
					<div className="flex flex-col gap-1">
						<ControlledCheckbox
							...
							<span className="font-medium">
								{t("oacode:ghost.settings.enableQuickInlineTaskKeybinding.label")}
							</span>
						</ControlledCheckbox>
						<div className="text-vscode-descriptionForeground text-sm mt-1">
							<Trans
								i18nKey="oacode:ghost.settings.enableQuickInlineTaskKeybinding.description"
								components={{
									DocsLink: (
										<a
											href="#"
											onClick={() => openGlobalKeybindings("oa-code.ghost.promptCodeSuggestion")}
											className="text-vscode-textLink hover:text-vscode-textLinkActive cursor-pointer"></a>
									),
								}}
							/>
					...
					<div className="flex flex-col gap-1">
						<ControlledCheckbox
							...
							<span className="font-medium">
								{t("oacode:ghost.settings.enableSmartInlineTaskKeybinding.label")}
							</span>
						</ControlledCheckbox>
						<div className="text-vscode-descriptionForeground text-sm mt-1">
							<Trans
								i18nKey="oacode:ghost.settings.enableSmartInlineTaskKeybinding.description"
								components={{
									DocsLink: (
										<a
											href="#"
											onClick={() => openGlobalKeybindings("oa-code.ghost.generateSuggestions")}
											className="text-vscode-textLink hover:text-vscode-textLinkActive cursor-pointer"></a>
									),
								}}
							/>
				...
				<div className="flex flex-col gap-3">
					<div className="flex flex-col gap-1">
						<div className="flex items-center gap-2 font-bold">
							...
							<div>{t("oacode:ghost.settings.provider")}</div>
						</div>
					</div>
					<div className="flex flex-col gap-3">
						<div>
							<label className="block font-medium mb-1">
								{t("oacode:ghost.settings.apiConfigId.label")}
							</label>
							<div className="flex items-center gap-2">
								<div>
									<Select value={apiConfigId || "-"} onValueChange={onApiConfigIdChange}>
										<SelectTrigger data-testid="autocomplete-api-config-select" className="w-full">
											<SelectValue placeholder={t("oacode:ghost.settings.apiConfigId.current")} />
										</SelectTrigger>
										<SelectContent>
											<SelectItem value="-">
												{t("oacode:ghost.settings.apiConfigId.current")}
											</SelectItem>
									...
									<div className="text-sm text-vscode-descriptionForeground mt-1">
										{t("oacode:ghost.settings.apiConfigId.description")}
									</div>
								</div>
							</div>
						</div>

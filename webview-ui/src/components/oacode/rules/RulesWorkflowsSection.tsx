...
const RulesWorkflowsSection: React.FC<RulesWorkflowsSectionProps> = ({
	...
	const globalSectionKey =
		type === "rule" ? "oacode:rules.sections.globalRules" : "oacode:rules.sections.globalWorkflows"
	const workspaceSectionKey =
		type === "rule" ? "oacode:rules.sections.workspaceRules" : "oacode:rules.sections.workspaceWorkflows"

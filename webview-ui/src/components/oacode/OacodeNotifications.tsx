...
export const OacodeNotifications: React.FC = () => {
	...
	useEffect(() => {
		const handleMessage = (event: MessageEvent) => {
			...
			if (message.type === "oacodeNotificationsResponse") {
	...
	useEffect(() => {
		vscode.postMessage({ type: "fetchOacodeNotifications" })
	}, [])
	...
	return (
		<div className="oacode-notifications flex flex-col mb-4">

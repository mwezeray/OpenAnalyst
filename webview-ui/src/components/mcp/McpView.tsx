...
import {
	...
	DialogFooter,
	ToggleSwitch,
	// StandardTooltip, // oacode_change: not used
...
// import McpEnabledToggle from "./McpEnabledToggle" // oacode_change not used
import { McpErrorRow } from "./McpErrorRow"

type McpViewProps = {
	onDone: () => void
	hideHeader?: boolean // oacode_change
}
...
const McpView = ({ onDone, hideHeader = false }: McpViewProps) => {
	...
	return (
		// oacode_change: add relative className
		<Tab className="relative">
			{/*  oacode_change: display header conditionally */}
			...
			<TabContent>
				<div
					...
					<Trans i18nKey="mcp:description">
						<VSCodeLink
							href={buildDocLink("features/mcp/using-mcp-in-oa-code", "mcp_settings")}
				...
				{/* <McpEnabledToggle /> oacode_change: we always enable MCP */}

				{mcpEnabled && (
					<>
						{/* oacode_change: display: none; we always allow mcp server creation */}
						<div style={{ display: "none", marginBottom: 15 }}>
							...
							<div
								...
								<Trans i18nKey="mcp:enableServerCreation.description">
									<VSCodeLink
										href={buildDocLink(
											"features/mcp/using-mcp-in-oa-code#how-to-use-oa-code-to-create-an-mcp-server",
											"mcp_server_creation",
										)}
										style={{ display: "inline" }}>
						...
						<div
							...
							<VSCodeLink
								href={buildDocLink(
									"features/mcp/using-mcp-in-oa-code#editing-mcp-settings-files",
									"mcp_edit_settings",
								)}
								style={{ display: "inline" }}>

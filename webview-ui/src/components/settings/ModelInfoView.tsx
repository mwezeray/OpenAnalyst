...
export const ModelInfoView = ({
	...
	// oacode_change start
	const oaCodeTrustsThePricing =
		(apiProvider !== "oacode" && apiProvider !== "openrouter") ||
	...
	const infoItems = [
		...
		/>,
		/* oacode_change: supports computer use => supports browser
		<ModelInfoSupportsItem

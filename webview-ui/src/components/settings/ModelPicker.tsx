import { useState, useCallback, useEffect, useRef, Fragment } from "react" // oacode_change Fragment
...
import { usePreferredModels } from "@/components/ui/hooks/oacode/usePreferredModels" // oacode_change
// import { filterModels } from "./utils/organizationFilters" // oacode_change: not doing this
...
export const ModelPicker = ({
	...
	// organizationAllowList, // oacode_change: unused
	errorMessage,
}: ModelPickerProps) => {
	...
	const modelIds = usePreferredModels(models) // oacode_change
	...
	return (
		<>
			...
			<div className="text-sm text-vscode-descriptionForeground">
				{
					/*oacode_change start*/
					apiConfiguration.apiProvider === "oacode" ? (
						<Trans i18nKey="oacode:settings.provider.automaticFetch" />
					) : (
						<Trans

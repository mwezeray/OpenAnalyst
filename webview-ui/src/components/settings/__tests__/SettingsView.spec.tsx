...
vi.mock("@/components/ui", () => ({
	...
	SelectSeparator: () => <div data-testid="select-separator" />, // oacode_change
...
// oacode_change on next line, initial state initialization to work with localized checkboxes

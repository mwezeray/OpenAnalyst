...
import { TerminalCommandGeneratorSettings } from "./TerminalCommandGeneratorSettings" // oacode_change
...
type TerminalSettingsProps = HTMLAttributes<HTMLDivElement> & {
	...
	terminalCommandApiConfigId?: string // oacode_change
			...
			<Section>
				...
				<div className="flex flex-col gap-3">
					...
					<div className="flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background">
						...
						<div>
							<VSCodeCheckbox
								checked={terminalShellIntegrationDisabled ?? true /* oacode_change: default */}
								onChange={(e: any) =>

import React, { Fragment, memo, useCallback, useEffect, useMemo, useState } from "react" // oacode_change Fragment
...
import {
	...
	SelectContent,
	SelectItem,
	// SearchableSelect, // oacode_change
	SelectSeparator,
	Collapsible,
	CollapsibleTrigger,
	CollapsibleContent,
...
// import { ModelPicker } from "./ModelPicker" // oacode_change
...
import { OaCode } from "../oacode/settings/providers/OaCode" // oacode_change
import { OaCodeAdvanced } from "../oacode/settings/providers/OaCodeAdvanced" // oacode_change
import { buildDocLink } from "@src/utils/docLinks"

export interface ApiOptionsProps {
	uriScheme: string | undefined
	uiKind: string | undefined // oacode_change
	apiConfiguration: ProviderSettings
	setApiConfigurationField: <K extends keyof ProviderSettings>(field: K, value: ProviderSettings[K]) => void
	fromWelcomeView?: boolean
	errorMessage: string | undefined
	setErrorMessage: React.Dispatch<React.SetStateAction<string | undefined>>
	hideOaCodeButton?: boolean // oacode_change
	currentApiConfigName?: string // oacode_change
}

const ApiOptions = ({
	uriScheme,
	uiKind, // oacode_change
	apiConfiguration,
	setApiConfigurationField,
	fromWelcomeView,
	errorMessage,
	setErrorMessage,
	hideOaCodeButton = false,
	currentApiConfigName, // oacode_change
}: ApiOptionsProps) => {
	...
	const onProviderChange = useCallback(
		(value: ProviderName) => {
			...
			> = {
				...
				oacode: { field: "oacodeModel", default: oacodeDefaultModelId },
				// oacode_change end
			}
	...
	return (
		<div className="flex flex-col gap-3">
			...
			{/* oacode_change start */}
			{selectedProvider === "oacode" && (
				<OaCode
					apiConfiguration={apiConfiguration}
					setApiConfigurationField={setApiConfigurationField}
					hideOaCodeButton={hideOaCodeButton}

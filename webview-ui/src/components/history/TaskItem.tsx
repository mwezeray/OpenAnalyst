	...
	return (
		<div
			...
			className={cn(
				...
				{
					"bg-red-900 text-white": item.fileNotfound, // oacode_change added this state instead of removing
					"bg-vscode-editor-background": !item.fileNotfound, //oacode_change this is the default normally in the regular classname list
				},
				className,
			)}
			onClick={handleClick}>

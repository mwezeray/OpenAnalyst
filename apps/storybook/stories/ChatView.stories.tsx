...
export const EmptyWithNotificationsAndHistory: Story = {
	...
	decorators: [
		(Story) => {
			// Mock notifications for OacodeNotifications component
			React.useEffect(() => {
				const mockNotifications = [
					{
						...
						action: {
							...
							actionURL: "https://oacode.com/features/code-analysis",
						},
					},
					{
						id: "notification-2",
				...
				// Simulate the message event that OacodeNotifications listens for
	...
	parameters: {
		extensionState: {
			...
			apiConfiguration: {
				apiProvider: "oacode", // Set to oacode to show notifications
				apiModelId: "claude-3-5-sonnet-20241022",
				apiKey: "mock-key",
			},
			mcpServers: [],
